...
#include <stb/stb_image.h> // source: https://github.com/nothings/stb
...
private:
	...
	// Loads an image to host visible memory. A staging buffer is created
	// and mapped to transfer the iamge data to device memory.
	...
	void createImage(uint32_t width, uint32_t height, VkFormat format,
		...
		// The image info structure. It is used as a destination for the texel data.
